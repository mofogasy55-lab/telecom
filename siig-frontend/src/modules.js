export function getNavItemsForRole(role) {
  ...
  const admin = [
    ...
    { view: 'admin:semester-subject-plan', label: 'Planification matières (mois)', roles: ['admin'] },
  ...
  const prof = [
    ...
    { view: 'prof:semester-subject-plan', label: 'Planification matières (mois)', roles: ['prof'] },
